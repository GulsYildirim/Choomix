...
namespace _4.Sayfa
{
    public partial class Transportation : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            label13.Text = LoginAssign.kullanıcı;
            if ((label13.Text != LoginAssign.kullanıcı)|| (LoginAssign.kullanıcı == "0"))
            {
            ...
            {
                label13.Text = "HOŞGELDİN " + LoginAssign.kullanıcı;
        ...
        private void button22_Click(object sender, EventArgs e) //Sepete ekle butonu
        {
            ...
            TransportCity bilgi = new TransportCity();
            if (comboBox1.Text ==Ulasim_Yolu.Uçak.ToString())
            {
                bilgi.Fiyat = a;
                AdminLogin2.ulasımkisi = textBox4.Text;
                Basket.fiyatulaşım = a.ToString();
            }

            else if (comboBox1.Text == Ulasim_Yolu.Otobus.ToString())
            {
                bilgi.Fiyat = b;
                Basket.fiyatulaşım = b.ToString();
            }

            AdminLogin2.ulasımtoplami = label10.Text.ToString();
            Basket.kisisayisiulaşım = textBox4.Text;  

            int kisi;
            Int32.TryParse(textBox4.Text, out kisi);
            TransportCity obje = new TransportCity();
            obje.kisi = kisi;
            obje.ulasim_yolu = comboBox1.Text;

            int toplam_fiyat = obje.Hesap(); 
            label10.Text = toplam_fiyat.ToString();
            Basket.ulaşımtoplam = label10.Text.ToString(); 
