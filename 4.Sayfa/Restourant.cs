...
namespace _4.Sayfa
{
    public partial class Restourant : Form
    {   
        public int a;
        public int b;
        public int c;
        ...
        BaseClass atama = new RestourantCity();//polimorfizm kullandık
        Basket sepet = new Basket();
        Payment odeme = new Payment();
        RestourantCity isim = new RestourantCity();
        private void restoran_Load(object sender, EventArgs e)
        {
           
            BaseClass.kategori = "Restoran"; 

            this.AutoScroll = true;
            this.MaximizeBox = false;

           
            label82.Text = LoginAssign.kullanıcı;
            if ((label82.Text != LoginAssign.kullanıcı) || (LoginAssign.kullanıcı == "0"))
            {
            ...
            {
                label82.Text = "HOŞGELDİN " + LoginAssign.kullanıcı;
            ...
            RestourantCity restoran = new RestourantCity();
 
            label24.Text = BaseClass.isim;
            ...
            else if (BaseClass.isim == "Nevşehir")
            {
                sepet.birim = atama.x;
                label83.Text = isim.x;
                label84.Text = isim.x;
        ...
        {
            RestourantCity il = new RestourantCity();
            if (BaseClass.isim == "Antalya")
        ...
        BaseClass r = new Şehirler();
        private void button2_Click(object sender, EventArgs e)
        {   
            sepet.Add(r);

            Basket.kisisayisirestoran = textBox2.Text;
            AdminLogin2.restorankisi = textBox2.Text;
            Basket.restorantoplam = label51.Text;
            r.Fiyat = Convert.ToInt32(label51.Text);
            AdminLogin2.restorantoplami = label51.Text;
        ...
        {
            Basket.restoranisim = radioButton1.Text;

            RestourantCity bilgi = new RestourantCity();
            bilgi.YFiyati = a;
            Basket.günlükfiyatrestoran = a.ToString();
        ...
        {
            Basket.restoranisim = radioButton2.Text;
            
            RestourantCity bilgi = new RestourantCity();
          
            bilgi.YFiyati = b;
            Basket.günlükfiyatrestoran = b.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        ...
        {
            Basket.restoranisim = radioButton3.Text;
           

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = c;
            Basket.günlükfiyatrestoran = c.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton4.Text;
           ...
           RestourantCity bilgi = new RestourantCity();
            ...
            bilgi.YFiyati = d;
            Basket.günlükfiyatrestoran = d.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton5.Text;
           

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = f;
            Basket.günlükfiyatrestoran = f.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton6.Text;
            

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = g;
            Basket.günlükfiyatrestoran = g.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton8.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = x;
            Basket.günlükfiyatrestoran = x.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton9.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = s;
            Basket.günlükfiyatrestoran = s.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton10.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati =h;
            Basket.günlükfiyatrestoran = h.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton11.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = m;
            Basket.günlükfiyatrestoran = m.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton12.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati =k;
            Basket.günlükfiyatrestoran = k.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Basket.restoranisim = radioButton13.Text;

            RestourantCity bilgi = new RestourantCity();

            bilgi.YFiyati = l;
            Basket.günlükfiyatrestoran = l.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
